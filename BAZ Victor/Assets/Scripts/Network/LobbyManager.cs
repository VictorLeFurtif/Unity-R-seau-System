		...
		async void CreateLobby()
		{
			try
			{
				...
				CreateLobbyOptions createLobbyOptions = new()
				{
					...
					{
						{keyGameMode, new DataObject(DataObject.VisibilityOptions.Public,           "HIDE AND SEEK" /*,DataObject.IndexOptions.S1*/)},
						{keyMap, new DataObject(DataObject.VisibilityOptions.Public,                "GYM MAP")},
